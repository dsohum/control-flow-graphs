OBJ_GEN = scanner.o parser.o ast.o ast-compile.o icode.o cfg.o program.o
OBJ_CORE = main.o
OBJ = $(OBJ_GEN) $(OBJ_CORE) 


HEADERS_CORE = error-display.hh user-options.hh ast.hh symbol-table.hh program.hh procedure.hh common-classes.hh icode.hh cfg.hh
